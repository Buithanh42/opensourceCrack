...
function vu492.NewWindow(_, _, p508, p509)
    ...
    v519.Text = "LH-HUB HUB<font color=\'rgb(128,0,128)\'> KING LEGACY</font>"
    v519.RichText = true
...
v1142:Slider("Hold Z", 0, 100, vu456.Z, function(p1175)
    vu456.Z = p1175
    SaveSettings()
end)
v1142:Slider("Hold X", 0, 100, vu456.X, function(p1176)
    vu456.X = p1176
    SaveSettings()
end)
v1142:Slider("Hold C", 0, 100, vu456.C, function(p1177)
    vu456.C = p1177
    SaveSettings()
end)
v1142:Slider("Hold V", 0, 100, vu456.V, function(p1178)
    vu456.V = p1178
    SaveSettings()
end)
v1142:Slider("Hold B", 0, 100, vu456.B, function(p1179)
    vu456.B = p1179
    SaveSettings()
end)
v1142:Slider("Hold E", 0, 100, vu456.E, function(p1180)
    vu456.E = p1180
    SaveSettings()
end)
local vu1181 = 1
